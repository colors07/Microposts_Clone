...
?>
                ...
                <div class="col-xs-8">
                    <ul class="nav nav-tabs nav-justified">
                        ...
                        <li role="presentation" class="active"><a href="https://<?php echo $_SERVER["HTTP_HOST"]; ?>/Lesson12/Microposts/profile_followers.php?user_id=<?php echo $_GET["user_id"] ?>&relation=followers">Followers <span class="badge"><?php echo $followers_count; ?></span></a></li>
                    </ul>
