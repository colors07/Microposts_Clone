...
?>
                ...
                <div class="col-xs-8">
                    <ul class="nav nav-tabs nav-justified">
                        <li role="presentation" class=""><a href="https://<?php echo $_SERVER["HTTP_HOST"]; ?>/Lesson12/Microposts/profile.php?user_id=<?php echo $_GET["user_id"] ?>">Microposts <span class="badge"><?php echo $posts_count; ?></span></a></li>
                        <li role="presentation" class="active"><a href="https://<?php echo $_SERVER["HTTP_HOST"]; ?>/Lesson12/Microposts/profile_followings.php?user_id=<?php echo $_GET["user_id"] ?>&relation=followings">Followings <span class="badge"><?php echo $followings_count; ?></span></a></li>
...
<?php include($_SERVER["DOCUMENT_ROOT"] . "/Lesson12/Microposts/Parts/users_list.php"); ?>
                </div>
            </div>
        </div>
    </body>
